...
int main(int argc, char **argv)
{
	...
	pds.products=(FILE **)malloc(32*sizeof(FILE*));
	...
	fprintf(stderr,"main() starting copying strings\n");
	...
	fprintf(stderr,"main() before accessing the leaves\n");
...
*/        fprintf(stderr,"main() after modification_history\n");
	...
	if (init_pds(lp,&pds, prodfnam,argv)) perror("error in initing pds product archiving"); 
        fprintf(stderr,"main() after init_pds()\n");
    LIBXML_TEST_VERSION;
    ...
    p1=xmlNewChild(p1, NULL, BAD_CAST "", BAD_CAST NULL);
    xmlNewChild(p1, NULL, BAD_CAST "", BAD_CAST "");
    xmlNewChild(p1, NULL, BAD_CAST "", BAD_CAST "");
    xmlNewChild(p1, NULL, BAD_CAST "", BAD_CAST "");
    p1=p1->parent;p1=p1->parent;p1=p1->parent;
    fprintf(stderr,"main() step 2\n");
	...
	attr = xmlSetProp(p1, (const xmlChar *)array2d.leaves[0]->attributes[0].name,(const xmlChar *)array2d.leaves[0]->attributes[0].value);
	p1=p1->parent;
...
*/
    fprintf(stderr,"main() before saving xml\n");
