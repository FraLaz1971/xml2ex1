...
int main(int argc, char **argv)
{
    ...
    if(verbose)fprintf(stderr,"main() step 1\n");
    ...
    if(verbose)fprintf(stderr,"main() step 2\n");
	...
	p1=p1->parent;p1=p1->parent;
    if(verbose)fprintf(stderr,"main() step 3\n");
	...
	p1 = xmlNewChild(p1, NULL, BAD_CAST file.name, BAD_CAST NULL);
	xmlNewChild(p1, NULL, BAD_CAST file.leaves[0].name, BAD_CAST file.leaves[0].value);
	p1=p1->parent;
	...
	p1=p1->parent;
    if(verbose)fprintf(stderr,"main() step 4\n");
