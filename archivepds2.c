...
int main(int argc, char **argv)
{
  ...
  fclose(cfp);
	...
	strcpy((char*)array2d.leaves[3].leaves[0].value,"SignedLSB2");
	...
	strcpy((char*)array2d.leaves[4].leaves[1].value,"11520");
	...
	strcpy((char*)array2d.leaves[5].leaves[1].value,"23040");
